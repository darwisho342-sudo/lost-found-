...
localized_urlpatterns = [
    ...
    path("accounts/reauthenticate/", views.reauthenticate, name="reauthenticate"),
    path("scope/switch/", views.switch_scope, name="switch_scope"),
    ...
    path("claims/<int:pk>/appeal/", views.claim_appeal, name="claim_appeal"),
    ...
    path("report-content/<str:target_type>/<int:pk>/", views.report_content, name="report_content"),
    path("matches/<int:lost_pk>/<int:found_pk>/dismiss/", views.dismiss_match, name="dismiss_match"),
    ...
    path("management/claims/", views.management_claims, name="management_claims"),
    path("management/claims/appeals/<int:pk>/<str:action>/", views.management_appeal_action, name="management_appeal_action"),
    path("management/moderation/", views.management_moderation, name="management_moderation"),
    path("management/moderation/<int:pk>/<str:action>/", views.management_moderation_action, name="management_moderation_action"),
    path("management/locations/", views.management_locations, name="management_locations"),
    path("management/locations/<int:pk>/toggle/", views.management_location_toggle, name="management_location_toggle"),
    path("management/custody/", views.management_custody, name="management_custody"),
    path("management/custody/<int:pk>/incident/", views.management_custody_incident, name="management_custody_incident"),
    path("management/custody/<int:pk>/<str:action>/", views.management_custody_action, name="management_custody_action"),
    path("management/incidents/<int:pk>/resolve/", views.management_incident_resolve, name="management_incident_resolve"),
